...
from webdriver.common.options import BaseOptions
from webdriver.common.print_page_options import PrintOptions
from webdriver.common.timeouts import Timeouts
from webdriver.common.html5.application_cache import ApplicationCache
from webdriver.support.relative_locator import RelativeBy
from webdriver.common.virtual_authenticator import (
    Credential,
...
def get_remote_connection(capabilities, command_executor, keep_alive, ignore_local_proxy=False):
    from webdriver.chromium.remote_connection import ChromiumRemoteConnection
    from webdriver.safari.remote_connection import SafariRemoteConnection
    from webdriver.firefox.remote_connection import FirefoxRemoteConnection
